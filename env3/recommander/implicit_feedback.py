...
class Recommender(object):
    ...
    def _margin_comparator_loss(self, inputs, margin=1.):
        positive_pair_sim, negative_pair_sim = inputs
        return tf.maximum(negative_pair_sim - positive_pair_sim + margin, 0)

    def _make_interaction_mlp(self, input_dim, n_hidden=1, hidden_size=64,
    ...
    def _build_models(self, n_users, n_items, user_dim=32, item_dim=64, 
            metadata_dim=6, n_hidden=1, hidden_size=64, dropout=0, l2_reg=0):
        ...
        interaction_layers = self._make_interaction_mlp(
    ...
    def fit(self, state_history, reward_history, action_history,
            n_users, n_items, n_epochs=15):
        """ Fit the model """
